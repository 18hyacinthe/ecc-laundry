...
use App\Models\AdminReclamation;
...
class AdminReclamationDataTable extends DataTable
{
    /**
    ...
    public function dataTable(QueryBuilder $query): EloquentDataTable
    {
        return (new EloquentDataTable($query))
            ->addColumn('action', function ($query) {
                ...
                $viewBtn = "<button class='btn btn-sm btn-primary' title='" . __('View') . "' onclick='showReclamationDetails(\"" . $hashedId . "\")'><i class='fa fa-eye'></i></button>";
                return $viewBtn;
            })
            ...
            ->editColumn('user_id', function ($reclamation) {
                return $reclamation->user ? $reclamation->user->name : 'N/A';
            })
    ...
    public function query(Reclamation $model): QueryBuilder
    {
        ...
        return $model->newQuery()->with('machine');
    }
    ...
    {
        return 'AdminReclamation_' . date('YmdHis');
    }
}
