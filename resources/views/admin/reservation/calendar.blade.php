@extends('admin.dashboard.page-sans-footer')
...
<div id="legend" style="margin: 20px auto; max-width: 800px; text-align: center;">
    ...
    <div style="text-align: right; margin-top: 10px;">
        <a href="{{ route('admin.showReservationForm') }}" class="reserve-button" style="display: inline-block; transition: transform 0.3s;">
            {{ __('Réserver') }}
        </a>
    </div>
</div>
